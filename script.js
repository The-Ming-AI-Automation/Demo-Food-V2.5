...
bindEvents() {
    ...
    document
        ...
        .addEventListener("click", () => this.cycleLanguage());


    document
        .getElementById("askMingButton")
        .addEventListener("click", () => this.askMing());
...
askMing() {
    ...
    resultSummary.textContent = this.getResultSummary(input);
...
renderRestaurants() {
    ...
    grid.innerHTML = this.restaurants
        .map((restaurant) => {
            ...
            return `
                ...
                <article class="restaurant-card">
                    ...
                    <div class="restaurant-card-content">
                        ...
                        <div class="restaurant-score-row">
...
openRestaurant(id) {
    ...
    const positives = restaurant.positives[language]
        .map((item) => `<li>${item}</li>`)
        .join("");


    const negatives = restaurant.negatives[language]
        .map((item) => `<li>${item}</li>`)
        .join("");
    ...
    content.innerHTML = `
        ...
        <div class="modal-verdict">
            ...
            <div class="modal-verdict-label">

                ${language === "zh"
                    ? "MING'S HONEST TAKE"
                    : language === "bm"
                        ? "PANDANGAN JUJUR MING"
                        : "MING'S HONEST TAKE"}
...
cycleLanguage() {
    ...
    const currentIndex = languages
        .indexOf(this.currentLanguage);
...
applyLanguage() {
    ...
    input.placeholder =
        input.dataset[`placeholder${language === "zh"
            ? "Zh"
            : language === "en"
                ? "En"
                : "Bm"}`];
    ...
    languageToggle
        .querySelector(".language-active")
        .textContent = labels[language];
